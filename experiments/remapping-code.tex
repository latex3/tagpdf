\DocumentMetadata{uncompress,testphase=phase-II,pdfversion=1.7}
...
\cs_set_eq:NN\__tag_role_remap_default:nN \__tag_role_remap_inline:nN 
\__tag_role_remap_default:nN{chapter}\l_tmpa_tl 

abb \tagmcend\tagstructbegin{tag=\l_tmpa_tl}\tagmcbegin{tag=P}blub\tagmcend\tagstructend\tagmcbegin{tag=P} ccc
