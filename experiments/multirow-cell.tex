...
\cs_new_protected:Npn \__tbl_gset_untagged_row_cells:n #1 % #1 number of rows
  {
    \int_step_inline:nn {#1}
     {
      \prop_gput:Nee \g__tbl_untagged_cells_prop
       { \int_eval:n {\g__tbl_row_int + ##1},\int_use:N\g__tbl_col_int }{}
     }  
  }
...
\cs_new_protected:Npn \__tbl_add_multirow:n #1
 {
   ...
   \__tbl_gset_untagged_row_cells:n {#1-1}   
 }
