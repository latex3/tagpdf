...
attach-css      &              & boolean           &bool   &tagpdf-user\\
...
role/new-NS      &                & three brace groups& code &tagpdf-roles\\
...
page/exclude-header-footer & exclude-header-footer &choice & code &tagpdf-user\\
page/tag-header-footer & &choice & code &tagpdf-user\\
...
\\\bottomrule
\end{longtable}
\bookmark[dest=\csname @currentHref\endcsname,level=section]{List of keys} 