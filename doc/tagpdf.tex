...
\DocumentMetadata{pdfversion=2.0,lang=en-UK,testphase=phase-II,pdfstandard=a-2b}
...
The \PDF{} reference formulate various rules about whether a structure can be 
a child of another structure. In the \PDF{} 1.7 reference this rule were 
rather vage, in the \PDF{} 2.0  reference there is a rather specific matrix, 
which sadly missed some of the tags from \PDF{} 1.7. The ISO norm 32005 will 
address this problem and extend the matrix (but still miss the \texttt{math} 
tag). Beside the parent-child matrix additional rules can be found in the  
descriptions of the standard structure types and in standards like \PDF/UA. 
