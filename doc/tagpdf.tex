...
Parent-child checks can be disabled with \verb+\tagpdfsetup{debug/parent-child-check=off}+. But this will be speed up the compilation but should be used with care, parent-child checks are an important tool to detect faulty structures!
