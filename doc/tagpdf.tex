...
As an example, for a reason that I don't understand the Adobe preflight 
...
Tag names are used a lot and to avoid to slow down the compilation they are not purified and checked. They are also normally not passed through some escaping command, but there can be code parts where it happens anyway. It lies in the responsability of the user to use sensible names that do not break under such conditions.
