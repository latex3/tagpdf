   ...
   \cs_new_protected:Npn \tag_check_parent_child:nnN #1 #2 #3
     {
       ...
       \quark_if_no_value:NTF \l__tag_tmpa_tl
         {
           \pdfdict_get:nnN {g__tag_role/RoleMap_dict}{#1}\l__tag_tmpa_tl
         }
         {
       ...
       \tl_show:N\l__tag_tmpa_tl  
       \prop_get:NnN\g__tag_role_index_prop {#2}\l__tag_tmpb_tl
       \quark_if_no_value:NTF \l__tag_tmpb_tl
         {
           \pdfdict_get:nnN {g__tag_role/RoleMap_dict}{#2}\l__tag_tmpb_tl           
         }     
         {
