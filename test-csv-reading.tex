...
\begin{document}
\ExplSyntaxOn
\tl_new:N\l__tag_rolemap_info_tmpa_tl
\tl_new:N\l__tag_rolemap_info_tmpb_tl
\msg_new:nnn { tag } {role-parent-child} { The~relation~of~parent~'#1\l__tag_rolemap_info_tmpa_tl'~and~child~'#2\l__tag_rolemap_info_tmpb_tl'~is~#3}
% from tagpdf.dtx ...
...
%    \begin{macrocode}
     {         
       \seq_map_indexed_inline:Nn \l__tag_tmpa_seq
         {
           \prop_gput:Nnx\g__tag_role_index_prop {##2}{\int_compare:nNnT{##1}<{10}{0}##1}           
         }  
     }
%    \end{macrocode}
% now the data lines.
   ...
   \cs_new_protected:Npn \tag_check_parent_child:nnN #1 #2 #3
     {
       \prop_get:NnNTF \g__tag_role_index_prop {#1}\l__tag_tmpa_tl
         {
           \tl_set:Nn \l__tag_rolemap_info_tmpa_tl {}
           \tl_set:Nn \l__tag_tmpa_tl {#1}
         }
         {
           \tl_set:Nn \l__tag_rolemap_info_tmpa_tl {~(#1)}
       ...
       \prop_get:NnNTF \g__tag_role_index_prop {#2}\l__tag_tmpb_tl
         {
           \tl_set:Nn \l__tag_rolemap_info_tmpb_tl {}
           \tl_set:Nn \l__tag_tmpb_tl {#2}
         }
         {
           \tl_set:Nn \l__tag_rolemap_info_tmpb_tl {~(#2)}
