...
a number of errors corrected, the code has been properly documentated (and the code documentation can now be compiled and 
printed).

There are nevertheless also a few changes for the public interface, one of them even a breaking change 
\begin{description}
\item[More engines supported] The generic mode of \pkg{tagpdf} now works 
