...
\section{Structure destinations}
 ...
 Starting with pdf~2.0 destinations can in a tagged PDF also point to a structure, to a \texttt{/StructElem} object.
 ...
 Support for the new keys have been added to the pdfmanagement and \pkg{tagpdf} will make
 use of it if possible. In most cases it should simply work, but in some cases 
 code that place destinations should be change to place them inside the structure they
 belong too. It can also be necessary to surround 
 destinations in the \enquote{middle} of a structure with a dummy structure (a Span or an Artifact) to
