...
A command \cs{tag_if_active:TF} to test if tagging is active has been added. This allow external packages to write conditional code.

The commands \cs{tag_struct_parent_int:} and \cs{tag_struct_insert_annot:nn} have been added. They allow to 
...
\cs{tag_finish_structure:} is no longer a public command.
