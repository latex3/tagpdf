...
|interwordspace| can be used without actually tagging a document. In luamode you should then use the settings
|activate-mc|, |interwordspace| and |tagunmarked=false|. 
