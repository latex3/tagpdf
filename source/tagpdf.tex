...
\begin{docCommand}{tag_mc_begin_pop:n}\Arg{key-value}\end{docCommand}

If there is an open mc chunk,
\cs{tag_mc_end_push:} ends it and pushes its tag on a stack. If there is no
...
To allow to test with both versions it is possible to switch for a document with \textt{global-mc} to global attributes.
